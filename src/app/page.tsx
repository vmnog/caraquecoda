...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-between w-full bg-black bg-dot-white/[0.2] relative flex items-center justify-center pb-24">
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
      <header className="absolute z-10 top-0 left-0 flex items-center justify-between p-8 w-full">
        <img src="/caraquecoda-icon-heading.svg" className="w-48" />
        <a
          href="#"
          className="text-white text-sm underline-offset-4 hover:underline hover:cursor-default"
        >
          Entrar em contato
        </a>
      </header>
      <div className="h-[40rem] w-full rounded-md flex md:items-center md:justify-center antialiased relative overflow-hidden">
        ...
        <div className="p-4 max-w-7xl mx-auto relative z-10 w-full pt-20 md:pt-0">
          <h1 className="text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
            Simplicidade <br /> em{" "}
            <span className="text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-t from-yellow-500 to-yellow-200 bg-opacity-50">
              Software.
            </span>
          </h1>
          <p className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
            Esqueça os custos com retrabalhos. Com nosso serviço, você tem a
            certeza de projetos entregues com excelência desde o início.
          </p>
        </div>
      </div>
